...
import { TestElements, ElementsType, TestElementInstance } from "@/types/TestElements";
...
export default function Designer() {
    ...
    useDndMonitor({
      onDragEnd:(event) => {
        ...
        if(droppingSidebarBtnOverDesignerDropArea) {
          ...
          const newElement = TestElements[type].construct(v4())
  ...
  function DesignerElementWrapper ({element}:{element:TestElementInstance}) {
    ...
    const DesignerElement = TestElements[element.type].designerComponent

    return <div ref={draggable.setNodeRef} {...draggable.listeners} {...draggable.attributes} className='relative flex flex-col text-foreground hover:cursor-pointer rounded-md ring-1 ring-accent ring-inset'
